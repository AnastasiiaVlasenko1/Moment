  ...
  return (
    <main data-el="not-found" className="flex min-h-svh items-center justify-center">
      <div className="text-center">
        <h1 data-el="not-found-title" className="text-4xl leading-none font-bold tracking-tight">404</h1>
        <h2 data-el="not-found-subtitle" className="mt-3 text-base font-normal text-muted-foreground">The page you're looking for doesn't exist or has moved.</h2>
